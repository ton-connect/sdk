...
export const CreateJettonDemo = () => {
    ...
    return (
        <>
            ...
            {data && Object.keys(data).length > 0 && <ResultPanel title="Response" src={data} />}
        </>
    );
};
