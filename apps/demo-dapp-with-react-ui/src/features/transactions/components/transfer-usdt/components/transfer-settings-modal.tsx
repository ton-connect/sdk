...
import { requiresGaslessItemsMode, type GaslessMode } from '../hooks/use-transfer-form';
...
export const TransferSettingsModal = ({
    ...
    const messagesDisabled = requiresGaslessItemsMode(gasless, withConnect);
            ...
            <div className="flex flex-col gap-4" data-testid="transfer-usdt-settings-modal">
                <label className="flex cursor-pointer flex-col gap-1">
                    ...
                    <span className="pl-6 text-xs text-secondary-foreground">
                        Bundle the transfer into the connect URL (connect + send in one screen).
                        Works for standard transfers; gasless uses{' '}
                        <code className="text-foreground">signMessage</code> with structured items
                        when embedded.
                    </span>
                </label>
