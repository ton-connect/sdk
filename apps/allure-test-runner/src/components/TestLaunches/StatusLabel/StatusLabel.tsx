...
export function StatusLabel({ status }: StatusLabelProps) {
    ...
    const getIcon = () => {
        switch (displayStatus) {
            case 'passed':
                return (
                    <svg
                        className="status-icon status-icon--passed"
                        viewBox="0 0 24 24"
                        fill="none"
                    >
                        <path
            ...
            case 'unknown':
                return (
                    <svg
                        className="status-icon status-icon--unknown"
                        viewBox="0 0 24 24"
                        fill="none"
                    >
                        <path
            ...
            default: // in-progress
                return (
                    <svg
                        className="status-icon status-icon--in-progress"
                        viewBox="0 0 24 24"
                        fill="none"
                    >
                        <rect
    ...
    return <span className={`status-checkbox status-checkbox--${displayStatus}`}>{getIcon()}</span>;
}
