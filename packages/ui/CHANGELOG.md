...
-   **ui:** `tonConnectUI.wallet` now is `Wallet | (Wallet & WalletInfoWithOpenMethod) | null`
...
-   **ui:** "Open Wallet" button with deeplink click fallback added -- button opens the second tab
    in the modal
...
-   **ui:** mobile buttons animation fixes. Tab bar elements cursor fixed. Body scroll disabling
    when modal opened improved
