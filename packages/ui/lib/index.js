...
import { TonConnectError, isWalletInfoCurrentlyInjected, toUserFriendlyAddress, CHAIN, TonConnect, isWalletInfoRemote, isWalletInfoCurrentlyEmbedded, isTelegramUrl } from "@tonconnect/sdk";
  ...
  return createComponent(WalletItemStyled, {
    ...
    get children() {
      return [createMemo(() => createMemo(() => typeof props.icon === "string")() ? createComponent(ImageStyled$1, {
        ...
        get colorPrimary() {
          var _a;
          return (_a = props.secondLineColorPrimary) != null ? _a : true;
        },
        get children() {
...
const MobileUniversalModal = (props) => {
  ...
  const universalLink = createMemo(() => connector.connect(props.walletsList.filter(isWalletInfoRemote).map((item) => ({
  ...
  subscribeToWalletChange() {
    this.connector.onStatusChange((wallet) => __async(this, null, function* () {
      ...
      if (wallet) {
        ...
        this.setPreferredWalletAppName(((_a = this.walletInfo) == null ? void 0 : _a.appName) || wallet.device.appName);
      } else {
        this.walletInfoStorage.removeWalletInfo();
      }
    }));
